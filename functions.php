...
function hackeryou_styles(){
	...
	wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Abril+Fatface|Fjalla+One|Open+Sans:300,400,600,700');
...
function hackeryou_continue_reading_link() {
	return ' <a href="'. get_permalink() . '" class="read-more">Continue reading <span class="meta-nav">></span></a>';
}
...
function hackeryou_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => 'The contact form widget area',
...
/* featured_image_url() - Displays the featured image */
